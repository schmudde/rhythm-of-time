...
var vec__36080 = axis;
var a_x = cljs.core.nth.call(null,vec__36080,(0),null);
var a_y = cljs.core.nth.call(null,vec__36080,(1),null);
var a_z = cljs.core.nth.call(null,vec__36080,(2),null);
var vec__36083 = v;
var x = cljs.core.nth.call(null,vec__36083,(0),null);
var y = cljs.core.nth.call(null,vec__36083,(1),null);
var z = cljs.core.nth.call(null,vec__36083,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__36086,p__36087){
var vec__36094 = p__36086;
var u1 = cljs.core.nth.call(null,vec__36094,(0),null);
var u2 = cljs.core.nth.call(null,vec__36094,(1),null);
var u3 = cljs.core.nth.call(null,vec__36094,(2),null);
var vec__36097 = p__36087;
var v1 = cljs.core.nth.call(null,vec__36097,(0),null);
var v2 = cljs.core.nth.call(null,vec__36097,(1),null);
var v3 = cljs.core.nth.call(null,vec__36097,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__36100_SHARP_){
return (p1__36100_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__36101_SHARP_,axis,angle);
});})(axis))
;
...
return (function (p1__36102_SHARP_){
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__36102_SHARP_,angle_lr),angle_ud);
...
var map__36109 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__36109__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__36109__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__36111 = cljs.core._EQ_;
var expr__36112 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__36111.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__36112))){
return straight;
} else {
if(cljs.core.truth_(pred__36111.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__36112))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__36111.call(null,quil.middlewares.navigation_3d.space,expr__36112))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__36111.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__36112))){
return up;
} else {
if(cljs.core.truth_(pred__36111.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__36112))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__36111.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__36112))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__36109,map__36109__$1,up,straight){
return (function (p1__36103_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__36103_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__36109,map__36109__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__36114_SHARP_);
});})(initial_state))
);
});
/**
...
var map__36126_36137 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__36126_36138__$1 = ((((!((map__36126_36137 == null)))?((((map__36126_36137.cljs$lang$protocol_mask$partition0$ & (64))) || (map__36126_36137.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__36126_36137):map__36126_36137);
var vec__36127_36139 = cljs.core.get.call(null,map__36126_36138__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_36140 = cljs.core.nth.call(null,vec__36127_36139,(0),null);
var c_y_36141 = cljs.core.nth.call(null,vec__36127_36139,(1),null);
var c_z_36142 = cljs.core.nth.call(null,vec__36127_36139,(2),null);
var vec__36130_36143 = cljs.core.get.call(null,map__36126_36138__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_36144 = cljs.core.nth.call(null,vec__36130_36143,(0),null);
var u_y_36145 = cljs.core.nth.call(null,vec__36130_36143,(1),null);
var u_z_36146 = cljs.core.nth.call(null,vec__36130_36143,(2),null);
var vec__36133_36147 = cljs.core.get.call(null,map__36126_36138__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_36148 = cljs.core.nth.call(null,vec__36133_36147,(0),null);
var p_y_36149 = cljs.core.nth.call(null,vec__36133_36147,(1),null);
var p_z_36150 = cljs.core.nth.call(null,vec__36133_36147,(2),null);
quil.core.camera.call(null,p_x_36148,p_y_36149,p_z_36150,(p_x_36148 + c_x_36140),(p_y_36149 + c_y_36141),(p_z_36150 + c_z_36142),u_x_36144,u_y_36145,u_z_36146);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1469933695466