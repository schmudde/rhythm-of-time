...
var vec__24617 = axis;
var a_x = cljs.core.nth.call(null,vec__24617,(0),null);
var a_y = cljs.core.nth.call(null,vec__24617,(1),null);
var a_z = cljs.core.nth.call(null,vec__24617,(2),null);
var vec__24620 = v;
var x = cljs.core.nth.call(null,vec__24620,(0),null);
var y = cljs.core.nth.call(null,vec__24620,(1),null);
var z = cljs.core.nth.call(null,vec__24620,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__24623,p__24624){
var vec__24631 = p__24623;
var u1 = cljs.core.nth.call(null,vec__24631,(0),null);
var u2 = cljs.core.nth.call(null,vec__24631,(1),null);
var u3 = cljs.core.nth.call(null,vec__24631,(2),null);
var vec__24634 = p__24624;
var v1 = cljs.core.nth.call(null,vec__24634,(0),null);
var v2 = cljs.core.nth.call(null,vec__24634,(1),null);
var v3 = cljs.core.nth.call(null,vec__24634,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__24637_SHARP_){
return (p1__24637_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__24638_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__24639_SHARP_,angle_lr),angle_ud);
...
var map__24646 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__24646__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__24646__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__24648 = cljs.core._EQ_;
var expr__24649 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__24648.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__24649))){
return straight;
} else {
if(cljs.core.truth_(pred__24648.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__24649))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__24648.call(null,quil.middlewares.navigation_3d.space,expr__24649))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__24648.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__24649))){
return up;
} else {
if(cljs.core.truth_(pred__24648.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__24649))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__24648.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__24649))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__24646,map__24646__$1,up,straight){
return (function (p1__24640_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__24640_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__24646,map__24646__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__24651_SHARP_);
});})(initial_state))
);
});
/**
...
var map__24663_24674 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__24663_24675__$1 = ((((!((map__24663_24674 == null)))?((((map__24663_24674.cljs$lang$protocol_mask$partition0$ & (64))) || (map__24663_24674.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__24663_24674):map__24663_24674);
var vec__24664_24676 = cljs.core.get.call(null,map__24663_24675__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_24677 = cljs.core.nth.call(null,vec__24664_24676,(0),null);
var c_y_24678 = cljs.core.nth.call(null,vec__24664_24676,(1),null);
var c_z_24679 = cljs.core.nth.call(null,vec__24664_24676,(2),null);
var vec__24667_24680 = cljs.core.get.call(null,map__24663_24675__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_24681 = cljs.core.nth.call(null,vec__24667_24680,(0),null);
var u_y_24682 = cljs.core.nth.call(null,vec__24667_24680,(1),null);
var u_z_24683 = cljs.core.nth.call(null,vec__24667_24680,(2),null);
var vec__24670_24684 = cljs.core.get.call(null,map__24663_24675__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_24685 = cljs.core.nth.call(null,vec__24670_24684,(0),null);
var p_y_24686 = cljs.core.nth.call(null,vec__24670_24684,(1),null);
var p_z_24687 = cljs.core.nth.call(null,vec__24670_24684,(2),null);
quil.core.camera.call(null,p_x_24685,p_y_24686,p_z_24687,(p_x_24685 + c_x_24677),(p_y_24686 + c_y_24678),(p_z_24687 + c_z_24679),u_x_24681,u_y_24682,u_z_24683);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1468519956392