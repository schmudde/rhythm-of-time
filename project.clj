(defproject rhythm-of-time "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "rhythm-of-time.core/on-js-reload"
                ...
                :compiler {:main rhythm-of-time.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/rhythm_of_time.js"
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/rhythm_of_time.js"
                           :main rhythm-of-time.core
